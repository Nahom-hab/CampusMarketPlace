...
const ForgetPassword = ({ navigation, setIsLoggedIn }) => {
                ...
                <View style={tw`px-8`}>
                    ...
                    <View style={tw`items-center mb-12`}>
                        <Image
                            ...
                            resizeMode="cover"
                        />
                        <Text style={tw`text-green-600 mt-5 text-lg`}>Forget Your Password </Text>
                    </View>
                    ...
                    >
                        <Text style={tw`text-white text-center font-bold text-lg`}>Send Reset Link</Text>
                    </TouchableOpacity>
                    ...
                    <View style={tw`flex-row justify-between`}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                            <Text style={tw`text-green-600 z-50 text-sm`}>Login</Text>
                        </TouchableOpacity>
                    </View>
